...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio,alt={Grafo base de la red corporativa}]{../results/figures/grafo_red.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Grafo resaltando betweenness centrality}]{../results/figures/grafo_centralidad_bc.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Comparacion de centralidades en barras}]{../results/figures/centralidad_barras.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Grafo con nodos anomalos destacados}]{../results/figures/grafo_anomalias.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Barras de z-score por nodo}]{../results/figures/zscore_barras.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Comparacion de curvas SIR}]{../results/figures/sir_comparacion.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Barrido de beta en la simulacion SIR}]{../results/figures/sir_betas.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Impacto de una cuarentena temprana}]{../results/figures/sir_cuarentena.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Grafo con articulaciones y puentes}]{../results/figures/resiliencia_grafo.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Impacto por eliminacion de nodos criticos}]{../results/figures/resiliencia_impacto.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Comparacion entre capturas IoT-23}]{../results/figures/botnet_comparacion.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Z-score de deteccion para Mirai}]{../results/figures/botnet_Capture11_Miraiscan_zscore.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Matriz de confusion multicaptura}]{../results/figures/botnet_confusion_multi.png}
...
\subsection{Evidencia adicional: deteccion de botnets}\label{evidencia-adicional-botnets}

\begin{frame}{Trafico capturado --- imagen 1}
\protect\phantomsection\label{botnet-img-1}
\begin{center}
\includegraphics[width=0.85\textwidth]{botnet_imgs/botnet_img1.jpeg}
\end{center}
\end{frame}

\begin{frame}{Trafico capturado --- imagen 2}
\protect\phantomsection\label{botnet-img-2}
\begin{center}
\includegraphics[width=0.85\textwidth]{botnet_imgs/botnet_img2.jpeg}
\end{center}
\end{frame}

\begin{frame}{Trafico capturado --- imagen 3}
\protect\phantomsection\label{botnet-img-3}
\begin{center}
\includegraphics[width=0.85\textwidth]{botnet_imgs/botnet_img3.jpeg}
\end{center}
\end{frame}

\begin{frame}{Trafico capturado --- imagen 4}
\protect\phantomsection\label{botnet-img-4}
\begin{center}
\includegraphics[width=0.85\textwidth]{botnet_imgs/botnet_img4.jpeg}
\end{center}
\end{frame}

\begin{frame}{Trafico capturado --- imagen 5}
\protect\phantomsection\label{botnet-img-5}
\begin{center}
\includegraphics[width=0.85\textwidth]{botnet_imgs/botnet_img5.jpeg}
\end{center}
\end{frame}
